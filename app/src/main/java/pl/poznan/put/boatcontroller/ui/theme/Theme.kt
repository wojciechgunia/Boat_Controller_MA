...
private val DarkColorScheme = darkColorScheme(
    ...
    secondaryContainer = DarkPlaceholder, // Tło bocznych paneli/przycisków
    onSecondaryContainer = DarkOnSurface, // Tekst na secondaryContainer
...
private val LightColorScheme = lightColorScheme(
    ...
    onPrimary = AppWhite, // Tekst/ikony na przyciskach primary
    secondary = PrimaryLightBlue, // Jaśniejszy niebieski dla tekstu w Tab'ach i tytułów sekcji
    secondaryContainer = LightPlaceholder, // Tło bocznych paneli/przycisków
    onSecondaryContainer = LightOnSurface, // Tekst na secondaryContainer
